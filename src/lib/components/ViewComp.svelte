...
<script lang="ts">
  ...
  import PendingMigration from '$lib/components/views/PendingMigration.svelte';
...
<div class="flex h-full flex-col overflow-hidden rounded-lg border border-border">
  <Tabs.Root bind:value={viewStore.viewId} class="flex h-full flex-col">
    ...
    <div class="flex-1 overflow-auto">
      ...
      <Tabs.Content value="model" class="h-full">
        <PendingMigration sourceFile="frontend/app/src/components/views/ModelView.vue" />
      </Tabs.Content>
      ...
      <Tabs.Content value="results" class="h-full">
        <PendingMigration sourceFile="frontend/app/src/components/views/ResultsView.vue" />
      </Tabs.Content>
