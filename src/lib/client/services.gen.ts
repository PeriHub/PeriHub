 ...
 * @throws ApiError
 */
export const getMyUsage = (): CancelablePromise<GetMyUsageResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/usage/me'
}); };
 ...
 * @throws ApiError
 */
export const getLicenseStatus = (): CancelablePromise<GetLicenseStatusResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/license/status'
}); };
