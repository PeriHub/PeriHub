...
export const $LicenseStatus = {
    properties: {
        ...
        license_server_configured: {
            type: 'boolean',
            title: 'License Server Configured'
        }
    },
    type: 'object',
    required: ['plan', 'features', 'source', 'license_server_configured'],
    title: 'LicenseStatus',
...
export const $Valve = {
    ...
    type: 'object',
    required: ['name', 'type', 'value', 'value_type', 'label', 'description'],
    title: 'Valve'
} as const;
