        ...
        <q-list v-for="damage, index in damages" :key="damage.damagesId" style="padding: 0px">
            <div
                ...
                <div class="row my-row">
                    <q-input class="my-input" v-model="damage.name" :rules="[rules.required, rules.name]"
                        :label="damageKeys.name" standout dense></q-input>
                ...
                <div class="row my-row" v-if="damage.damageModel == 'Von Mises Stress'">
                    ...
                    <q-input class="my-input" v-model="damage.criticalDamageToNeglect"
                        :rules="[rules.required, rules.float]" :label="damageKeys.criticalDamageToNeglect" clearable
                ...
                <div class="row my-row" v-if="damage.criticalEnergyCalc.calculateCriticalEnergy">
                    <q-input class="my-input" v-model="damage.criticalEnergyCalc.k1c" :rules="[rules.required, rules.float]"
                        label="Fracture Toughness (K1C)" @update:model-value="calculateCriticalEnergy(index)" clearable
                        standout dense></q-input>
                </div>
                    ...
                    <q-list v-for="prop, subindex in damage.interBlocks" :key="prop.damagesInterId" style="padding: 0px">
                        <div class="row my-row">
                            <q-select class="my-input" :options="blocks" option-label="blocksId" option-value="blocksId"
                                emit-value v-model="prop.firstBlockId" label="First Block Id" standout dense></q-select>
                            <q-select class="my-input" :options="blocks" option-label="blocksId" option-value="blocksId"
                                emit-value v-model="prop.secondBlockId" label="Second Block Id" standout dense></q-select>
