          ...
          <v-card width="400px">
            ...
            <v-col class="textfield-col">
              <v-text-field
                ...
                label="Velocity [mm/s]"
                :append-icon="'mdi-content-copy'"
                @click:append="copyText('velocity')"
                id="velocity"
                clearable
                outlined
              ></v-text-field>
            ...
            <v-col class="textfield-col">
              <v-text-field
                ...
                :append-icon="'mdi-content-copy'"
                @click:append="copyText('acceleration')"
                id="acceleration"
                clearable
                outlined
              ></v-text-field>
            ...
            <v-col class="textfield-col">
              <v-text-field
                ...
                label="Pressure [MPa]"
                :append-icon="'mdi-content-copy'"
                @click:append="copyText('pressure')"
                id="pressure"
                clearable
                outlined
              ></v-text-field>
            ...
            <v-col class="textfield-col">
              <v-text-field
                ...
                :append-icon="'mdi-content-copy'"
                @click:append="copyText('energyReleaseRate')"
                id="energyReleaseRate"
                clearable
                outlined
              ></v-text-field>
            </v-col>
            <v-col class="textfield-col">
              <v-text-field
                ...
                :append-icon="'mdi-content-copy'"
                @click:append="copyText('fractureToughness')"
