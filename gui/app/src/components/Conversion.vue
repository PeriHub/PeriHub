            ...
            convert(){
                ...
                if (E!=null){
                    ...
                    if (v!=null){
                        ...
                        this.calculated.poissonsRatio = v
                        this.calculated.pWaveModulus = (E*(1-v))/((1+v)*(1-2*v))
                    }
                    if (M!=null){
                ...
                this.calculated.bulkModulus = Number(this.calculated.bulkModulus).toExponential()
                this.calculated.youngsModulus = Number(this.calculated.youngsModulus).toExponential()
                this.calculated.lameFirst = Number(this.calculated.lameFirst).toExponential()
                this.calculated.shearModulus = Number(this.calculated.shearModulus).toExponential()
                this.calculated.pWaveModulus = Number(this.calculated.pWaveModulus).toExponential()
            },
            resetResult(){
