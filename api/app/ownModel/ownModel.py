...
class ownModel(object):
    def __init__(self, filename = 'ownModel', material = '', damage = '', block = '', bc = '', compute = '', output = '', solver = '', username = ''):
        '''
        ...
        self.damBlock = ['']*len(self.bcDict)
        self.damBlock[2] = 'PMMADamage'

        self.intBlockId = ['']*len(self.bcDict)
        self.matBlock = ['PMMA']*len(self.bcDict)
