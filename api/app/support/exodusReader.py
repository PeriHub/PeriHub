...
pMMA_var_0_1e = ExodusIIReader(FileName=[path.join(filePath, ModelName + '_Output1.e')])

# get active view
renderView1 = GetActiveViewOrCreate('RenderView')

# get display properties
gIICmodel_Output1eDisplay = GetDisplayProperties(pMMA_var_0_1e, view=renderView1)

# set scalar coloring
ColorBy(gIICmodel_Output1eDisplay, ('POINTS', 'Displacement', 'Magnitude'))
...
gIICmodel_Output1eDisplay.RescaleTransferFunctionToDataRange(True, False)

# show color bar/color legend
gIICmodel_Output1eDisplay.SetScalarBarVisibility(renderView1, True)
...
layout1.SetSize(1300, 540)

# current camera placement for renderView1
renderView1.InteractionMode = '2D'
renderView1.CameraPosition = [25.19999895967635, 2.4648800138384104, 10000.0]
renderView1.CameraFocalPoint = [25.19999895967635, 2.4648800138384104, 0.0]
renderView1.CameraParallelScale = 25.322242194052194

# save screenshot
SaveScreenshot(path.join(filePath,'displ.jpg'), renderView1, ImageResolution=[1300, 540])

Delete(pMMA_var_0_1e)
del pMMA_var_0_1e