...
export const $Model = {
  ...
  type: 'object',
  required: ['ownModel', 'gcode', 'twoDimensional'],
  title: 'Model',
} as const;
...
export const $Solver = {
  ...
  type: 'object',
  required: ['initialTime', 'finalTime', 'solvertype', 'safetyFactor'],
  title: 'Solver',
} as const;
...
export const $ThermalModel = {
  properties: {
    ...
    applyThermalFlow: {
      type: 'boolean',
      title: 'Applythermalflow',
    },
    applyThermalExpansion: {
      type: 'boolean',
      title: 'Applythermalexpansion',
    },
    applyHeatTransfer: {
      type: 'boolean',
      title: 'Applyheattransfer',
    },
    thermalType: {
      type: 'string',
      title: 'Thermaltype',
