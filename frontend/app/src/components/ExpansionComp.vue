...
<template>
    <q-scroll-area style="height: calc(100vh - 185px);">
        <q-list bordered class="rounded-borders">
            ...
            <q-expansion-item v-model="panel[1]" expand-separator icon="fas fa-toolbox" label="Material">
                <MaterialSettings></MaterialSettings>
            </q-expansion-item>
            <q-expansion-item v-model="panel[2]" expand-separator icon="fas fa-toolbox" label="Additve">
                <AdditiveSettings></AdditiveSettings>
            </q-expansion-item>
            <q-expansion-item v-model="panel[3]" expand-separator icon="fas fa-cut" label="Damage Models">
                <DamageSettings></DamageSettings>
            </q-expansion-item>
            <q-expansion-item v-model="panel[4]" expand-separator icon="fas fa-th" label="Blocks">
            ...
            <q-expansion-item v-model="panel[6]" expand-separator icon="fas fa-project-diagram" label="Boundary Conditions">
                <BoundaryConditionsSettings></BoundaryConditionsSettings>
            </q-expansion-item>
            <q-expansion-item v-model="panel[7]" expand-separator icon="fas fa-filter" label="Bond Filters">
                <BondFilterSettings></BondFilterSettings>
            </q-expansion-item>
            <q-expansion-item v-model="panel[8]" expand-separator icon="fas fa-sign-out-alt" label="Output">
