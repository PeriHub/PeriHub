    ...
    <div>
        <q-list v-for="material, index in materials" :key="material.materialsId" style="padding: 0px">
            <div
                ...
                <div class="row my-row">
                    <q-select class="my-input" :options="materialModelName" v-model="material.matType"
                ...
                <div v-if="material.matType.includes('User')">
                    <q-list v-for="prop, subindex in material.properties" :key="prop.materialsPropId" style="padding: 0px">
                        <div class="row my-row">
                            <q-input class="my-input" v-model="prop.value" :rules="[rules.required, rules.float]"
                                :label="prop.name" standout dense></q-input>
                    ...
                    <div class="row my-row">
                        ...
                        <q-input class="my-input" v-model="material.numStateVars" :rules="[rules.required, rules.int]"
                            ...
                            @update:model-value="bus.emit('addStateVarsToOutput', material.numStateVars)" standout
                            dense></q-input>
                    </div>
                </div>
                <div class="row my-row">
                ...
                <div v-if="material.enableThermal">
                    <div class="row my-row">
                        <q-input class="my-input" v-model="material.specificHeatCapacity"
                            :rules="[rules.required, rules.float]" :label="materialKeys.specificHeatCapacity" standout
                            dense></q-input>
                        <q-input class="my-input" v-model="material.thermalConductivity"
                            :rules="[rules.required, rules.float]" :label="materialKeys.thermalConductivity" standout
                            dense></q-input>
                        <q-input class="my-input" v-model="material.heatTransferCoefficient"
                            :rules="[rules.required, rules.float]" :label="materialKeys.heatTransferCoefficient" standout
                            dense></q-input>
                    </div>
                    <div class="row my-row">
                        <q-toggle class="my-toggle" v-model="material.applyThermalFlow"
                            :label="materialKeys.applyThermalFlow" dense></q-toggle>
                        <q-toggle class="my-toggle" v-model="material.applyThermalStrain"
                            :label="materialKeys.applyThermalStrain" dense></q-toggle>
                        <q-toggle class="my-toggle" v-model="material.applyHeatTransfer"
                            :label="materialKeys.applyHeatTransfer" dense></q-toggle>
                        <q-toggle class="my-toggle" v-model="material.thermalBondBased"
                            :label="materialKeys.thermalBondBased" dense></q-toggle>
                    </div>
                    <div class="row my-row">
                        <q-input class="my-input" v-model="material.thermalExpansionCoefficient"
                            :rules="[rules.required, rules.float]" :label="materialKeys.thermalExpansionCoefficient"
                            clearable standout dense></q-input>
                        <q-input class="my-input" v-model="material.environmentalTemperature"
                            :rules="[rules.required, rules.float]" :label="materialKeys.environmentalTemperature" clearable
                            standout dense></q-input>
                    </div>
                    <q-separator></q-separator>
                    <h6 class="my-title">Additive</h6>
                    <div class="row my-row">
                        <q-input class="my-input" v-model="material.printBedTemperature"
                            :rules="[rules.required, rules.float]" :label="materialKeys.printBedTemperature" clearable
                            standout dense></q-input>
                        <q-input class="my-input" v-model="material.printBedThermalConductivity"
                            :rules="[rules.required, rules.float]" :label="materialKeys.printBedThermalConductivity"
                            clearable standout dense></q-input>
                    </div>
                    <div class="row my-row">
                        ...
                        <q-input class="my-input" v-model="material.surfaceCorrection"
                            :rules="[rules.required, rules.float]" :label="materialKeys.surfaceCorrection" clearable
                            standout dense></q-input>
                    </div>
                </div>
            </div>
