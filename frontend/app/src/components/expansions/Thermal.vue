...
import type { Thermal, ThermalModel } from 'src/client';
...
export default defineComponent({
  ...
  methods: {
    ...
    addThermalModel() {
      ...
      const newItem = len > 0 ? structuredClone(toRaw(this.thermal.thermalModels[len - 1])) as ThermalModel : {} as ThermalModel;
