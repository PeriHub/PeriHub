...
<template>
    <div>
        ...
        <q-input class="my-input" v-model="model.width"
            ...
            @update:model-value="bus.emit('updateCracklength')" :rules="[rules.required, rules.float]" label="Width"
            standout dense></q-input>
        ...
        <q-input v-show="model.modelNameSelected == 'PlateWithHole' & !model.ownModel" class="my-input"
