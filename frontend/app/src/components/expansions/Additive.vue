...
<template>
    <div>
            ...
            <div v-if="additive.enabled">
                ...
                <q-list
                    v-for="additiveModel, index in additive.additiveModels"
                    :key="additiveModel.additiveModelId"
                    style="padding: 0px"
                >
                    <div class="row my-row">
                        <q-input 
                            class="my-input"
                            v-model="additiveModel.name"
                        ...
                        <q-select 
                            ...
                            v-model="additiveModel.additiveType"
                            label="Type"
                            standout
                            dense
                        ></q-select>
                        <q-input 
                            class="my-input"
                            v-model="additiveModel.printTemp"
                        ...
                        <q-input 
                            class="my-input"
                            v-model="additiveModel.timeFactor"
                            :rules="[rules.required, rules.float]"
                            label="Time Factor"
                            standout
                            dense
    ...
    export default defineComponent({
        ...
        methods: {
            addAdditiveModel() {
                ...
                let newItem = deepCopy(this.additive.additiveModels[len - 1])
