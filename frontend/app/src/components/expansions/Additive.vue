        ...
        <div v-if="additive.enabled">
            ...
            <q-list v-for="additiveModel, index in additive.additiveModels" :key="additiveModel.additiveModelId"
                ...
                <div class="row my-row">
                    <q-input class="my-input" v-model="additiveModel.name" :rules="[rules.required, rules.name]"
                        label="Name" standout dense></q-input>
                    <q-select class="my-input" :options="additiveType" v-model="additiveModel.additiveType" label="Type"
