...
<template>
    <div class="row">
        <q-btn flat icon="fas fa-play" @click="runModel" :loading="submitLoading"
            ...
            <q-card>
                ...
                <q-card-section class="q-pt-none">
                    <q-select class="my-select" :options="modelData.outputs" option-label="name" option-value="name"
                        emit-value v-model="showResultsOutputName" label="Output Name" standout dense></q-select>
                </q-card-section>
                <q-card-actions align="right">
                    <q-btn flat label="Show" color="primary" v-close-popup
                        @click="showResults(showResultsOutputName)"></q-btn>
                    <q-btn flat label="Cancel" color="primary" v-close-popup></q-btn>
                </q-card-actions>
            </q-card>
        </q-dialog>
        ...
        <q-dialog v-model="dialogGetPlot" persistent max-width="800">
            <q-card>
                ...
                <q-card-section class="q-pt-none">
                    <q-select class="my-select" :options="modelData.outputs" option-label="name" option-value="name"
                        emit-value v-model="getPlotOutput" label="Output Name" standout dense></q-select>
                </q-card-section>
                <q-card-section class="q-pt-none">
                    <q-select class="my-select" :options="getPlotVariables" v-model="getPlotVariableX" label="Variable"
                ...
                <q-card-section class="q-pt-none">
                    <q-select class="my-select" :options="getPlotVariables" v-model="getPlotVariableY" label="Variable"
                        standout dense></q-select>
        ...
        <q-dialog v-model="dialogGetImagePython" persistent max-width="800">
            <q-card>
                ...
                <q-card-section class="q-pt-none">
                    <q-select class="my-select" :options="modelData.outputs" option-label="name" option-value="name"
                        emit-value v-model="getImageOutput" label="Output Name" standout dense></q-select>
                    <q-select class="my-select" :options="getImageVariable" v-model="getImageVariableSelected"
                        label="Variable" standout dense></q-select>
                ...
                <q-card-section class="q-pt-none">
                    ...
                    <q-input class="my-input" v-model="getImageDxFactor" :rules="[rules.required, rules.name]"
                        label="Dx Factor" standout dense></q-input>
        ...
        <q-dialog v-model="dialogDeleteData" persistent max-width="500">
            <q-card>
                ...
                <q-card-actions align="right">
                    ...
                    <q-btn flat label="User data" color="primary" v-close-popup
                        @click="dialogDeleteUserData = true"></q-btn>
                    <q-btn flat label="Cancel" color="primary" v-close-popup></q-btn>
                </q-card-actions>
            </q-card>
        </q-dialog>
