...
export default defineComponent({
    ...
    methods: {
        ...
        async enableWebsocket() {
            ...
            const socket_path = `ws${process.env.VUE_APP_API.split("http")[1]}/log?${queryString}`;

            // const socket_path = "ws" + process.env.VUE_APP_API.split("http")[1] + '/log?token=' + this.$api.defaults.headers.common['Authorization']
