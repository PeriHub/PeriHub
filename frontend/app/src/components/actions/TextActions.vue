...
export default defineComponent({
  ...
  methods: {
    async viewInputFile(loadFile) {
      ...
      viewInputFile({ modelName: this.modelStore.selectedModel.title, modelFolderName: this.modelData.model.modelFolderName, ownMesh: this.modelData.model.ownMesh })
        .then((response) => {
          this.$q.notify({
    ...
    writeInputFile() {
      ...
      writeInputFile({ modelName: this.modelStore.selectedModel.title, modelFolderName: this.modelData.model.modelFolderName, inputString: this.viewStore.textOutput })
        .then((response) => {
          this.$q.notify({
            message: response.message
          })
    ...
    async enableWebsocket() {
      ...
      const params = {
        model_name: this.modelStore.selectedModel.title,
