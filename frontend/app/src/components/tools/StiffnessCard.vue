...
export default defineComponent({
  ...
  methods: {
    convert() {
      ...
      this.calculated.C14 = this.calculated.C41 = this.calculated.C15 = this.calculated.C51 = this.calculated.C24 = this.calculated.C42 = +nu12 / +E2;
      this.calculated.C25 = this.calculated.C52 = this.calculated.C34 = this.calculated.C43 = this.calculated.C16 = this.calculated.C61 = +nu13 / +E3;
      this.calculated.C35 = this.calculated.C53 = this.calculated.C26 = this.calculated.C62 = this.calculated.C45 = this.calculated.C54 = +nu23 / +E3;
