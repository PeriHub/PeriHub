...
<template>
  <q-card bordered>
    ...
    <q-card-section>
      <div class="row">
        <div class="col">
          <q-input class="my-input" v-model="conversion.mass" label="Mass [kg]" clearable standout dense></q-input>
          ...
          <q-input class="my-input" v-model="conversion.pressure" label="Pressure [Pa]" clearable standout
            dense></q-input>
        ...
        <div class="col">
          ...
          <q-input class="my-input" v-model="conversionResults.length" label="Length [mm]" standout dense>
            <template v-slot:append>
          ...
          <q-input class="my-input" v-model="conversionResults.moment" label="Moment [Nmm]" standout dense>
            <template v-slot:append>
              <q-icon name='fas fa-copy' @click="copyText('moment')"></q-icon>
            </template>
          </q-input>
          <q-input class="my-input" v-model="conversionResults.pressure" label="Pressure [MPa]" standout dense>
            <template v-slot:append>
              <q-icon name='fas fa-copy' @click="copyText('pressure')"></q-icon>
            </template>
          </q-input>
          <q-input class="my-input" v-model="conversionResults.density" label="Density [t/mm^3]" standout dense>
            <template v-slot:append>
          ...
          <q-input class="my-input" v-model="conversionResults.energy" label="Energy [mJ]" standout dense>
            <template v-slot:append>
              <q-icon name='fas fa-copy' @click="copyText('energy')"></q-icon>
            </template>
          </q-input>
          <q-input class="my-input" v-model="conversionResults.energyReleaseRate" label="Energy release rate [N/mm]"
            standout dense>
            <template v-slot:append>
              <q-icon name='fas fa-copy' @click="copyText('energyReleaseRate')"></q-icon>
            </template>
          </q-input>
          <q-input class="my-input" v-model="conversionResults.fractureToughness"
            label="Fracture Toughness [MPa · mm^1/2]" standout dense>
            <template v-slot:append>
